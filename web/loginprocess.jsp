...
<%
    ...
    conn = java.sql.DriverManager.getConnection("jdbc:mysql://localhost/library_catalog", "root", "sesame");  //connection with database.. demo: db name, username:root, password: " "
