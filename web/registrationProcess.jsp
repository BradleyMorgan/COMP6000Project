...
<%
    ...
    java.sql.PreparedStatement st,st1;               // Statement: The object used for executing a static SQL statement and returning the results it produces.
    ...
    String qr = "SELECT username FROM users WHERE username = ?";    //query to select if the username already exists or not
    ...
    if(rs.next()) {
        ...
        String sql = "INSERT INTO users (username, password, email) values (?, ?, ?)";   //query to enter values in database
